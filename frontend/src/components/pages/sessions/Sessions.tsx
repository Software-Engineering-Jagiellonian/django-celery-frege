...
export const Sessions = () => {
  ...
  return (
    <div className={styles.sessionsWrapper}>
        ...
        {error !== "" && <div className={styles.errorMessage}>{error}. You must be logged in to access this resource.</div>}
        ...
        <div className={styles.sessionsList}>
            ...
            {sessions.map((session: SessionI) => <Session key={session.id} session={session} setSessions={setSessions} setError={setError} />)}
        </div>
    </div>
  );
};
