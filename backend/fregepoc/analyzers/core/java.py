...
from fregepoc.repositories.analyzers import AnalyzerFactory, BaseAnalyzer
...
class JavaFileAnalysisResult(TypedDict):
    lines_of_code: int
    token_count: int
...
class JavaAnalyzer(BaseAnalyzer[JavaFileAnalysisResult]):
