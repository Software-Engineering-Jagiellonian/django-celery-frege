...
from fregepoc.repositories.commit_messages import CommitMessagesQualityRepoAnalyzer, CommitMessageAnalyzer
...
def remove_database_entries(repo):
    repo_pk = repo.pk
