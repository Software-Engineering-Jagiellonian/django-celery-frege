...
class AnalyzeResult:
    def __init__(self, result) -> None:
        ...
        self.average_cyclomatic_complexity = self.functions_average("cyclomatic_complexity")
        self.average_parameter_count = self.functions_average("parameter_count")
        self.average_nesting_depth = self.functions_average("max_nesting_depth")
        self.max_nesting_depth = max(fun.max_nesting_depth for fun in self.function_list)
        self.nesting_depth = sum(fun.max_nesting_depth for fun in self.function_list)
        self.cyclomatic_complexity = sum(fun.cyclomatic_complexity for fun in self.function_list)
