...
from typing import ParamSpec, Protocol, TypedDict, TypeVar, runtime_checkable, ClassVar, Mapping, Type, Callable, \
    DefaultDict
...
class AnalyzerFactory:
    ...
    @classmethod
    def make_analyzers(cls, programming_language: ProgrammingLanguages, *args, **kwargs) -> list[BaseAnalyzer]:
        """
        ...
        """
        return [analyzer_cls(*args, **kwargs) for analyzer_cls in cls.analyzers[programming_language]]

    @classmethod
    def register(cls, programming_language: ProgrammingLanguages) -> Callable[[Type[BaseAnalyzer]], Type[BaseAnalyzer]]:
        """
