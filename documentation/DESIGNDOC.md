...
[Flower] (https://flower.readthedocs.io/en/latest/) is a web-based tool for monitoring and managing Celery. It provides real-time insights into tasks, queues, and worker statistics.

[Sphinx] (https://www.sphinx-doc.org/en/master/) is a documentation generator for Python projects. It allows the creation of structured, well-formatted documents directly from docstrings in the code.
...
[pytest] (https://docs.pytest.org/en/stable/) is a powerful testing framework that simplifies writing and executing tests in Python projects.
## Detailed design
